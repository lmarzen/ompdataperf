...
void cg_init(const int x, const int y, const int halo_depth, const int coefficient, double rx, double ry, double *rro,
  ...
  #pragma omp target update from(p[ : n], r[ : n], u[ : n], energy[ : n], density[ : n])
  #pragma omp target update to(p[ : n], r[ : n], u[ : n], energy[ : n], density[ : n])
...
#ifdef OMP_TARGET
  #pragma omp target update from(w[ : n], density[ : n])
  #pragma omp target update to(w[ : n], density[ : n])
  #pragma omp target teams distribute parallel for simd collapse(2)
#else
  #pragma omp parallel for
#endif
...
#ifdef OMP_TARGET
  #pragma omp target update from(w[ : n], kx[ : n], ky[ : n])
  #pragma omp target update to(w[ : n], kx[ : n], ky[ : n])
  #pragma omp target teams distribute parallel for simd collapse(2)
#else
  #pragma omp parallel for
#endif
...
#ifdef OMP_TARGET
  #pragma omp target update from(p[ : n], r[ : n], u[ : n], w[ : n])
  #pragma omp target update to(p[ : n], r[ : n], u[ : n], w[ : n])
