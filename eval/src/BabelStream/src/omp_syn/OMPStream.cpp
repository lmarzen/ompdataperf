...
void OMPStream<T>::mul()
{
  ...
  {}
  #pragma omp target enter data map(alloc: b[0:array_size])
  {}
  #pragma omp target teams distribute parallel for simd
#else
  #pragma omp parallel for
...
void OMPStream<T>::add()
{
  ...
  T *b = this->b;
  T *c = this->c;
  #pragma omp target exit data map(release: c[0:array_size])
  {}
  #pragma omp target enter data map(alloc: c[0:array_size])
  {}
  #pragma omp target teams distribute parallel for simd
#else
  #pragma omp parallel for
